...
import 'package:xflutter/widget/ui_empty_component.dart';

import '../common/base/page_controller.dart';
import '../common/base/page_state.dart';
...
Widget buildListView<T>(
    {required Widget Function(T item, int index) itemBuilder,
      ...
      Axis scrollDirection = Axis.vertical}) {
  if (data.isEmpty) {
    return UiEmptyComponent(pageType: EmptyPageType.noData);
  }
